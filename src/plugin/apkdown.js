  ...
  if (validCommands.includes(cmd)) {
    ...
    if (selectedAPK) {
      try {
        ...
        await Matrix.sendMessage(m.from, { image: { url: iconUrl }, caption: `Here is your selected APK:\n\nName: ${selectedAPK.name}\nsize: ${size}\n\n> A bot by Chucky` }, { quoted: m });
